...
export default function ProfileSection(props) {
  ...
  // const testingProfiles = Array(10).fill({ userName: 'User', profileImage: profileImage });
  ...
  return (
    ...
    <Paper component="main" sx={{ display: 'flex', overflow: 'visible', flexDirection: 'column', evaluation: 2, border: '1px solid lightgrey', boxShadow: 1, borderRadius: 1, }} >
      ...
      <Box sx={{ position: 'relative', padding: "30px 0 5px 0", display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: "center" }} >
      ...
      <Divider />
      <ProfileList title='Follower' profiles={testingProfiles} handleCollapse={handleFollowing} isListOpen={isFollowingOpen} />
